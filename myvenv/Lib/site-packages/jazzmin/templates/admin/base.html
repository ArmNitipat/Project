    ...
    {% if not is_popup %}
        ...
        {% if jazzmin_settings.show_sidebar %}
            ...
            <aside class="main-sidebar elevation-4 {{ jazzmin_ui.sidebar_classes }}" id="jazzy-sidebar">
                ...
                <div class="sidebar">
                    <div class="mt-3 pb-3 mb-3 d-flex"><!--class="user-panel mt-3 pb-3 mb-3 d-flex"-->
                        <div class="image">
                            {% if jazzmin_settings|has_jazzmin_setting:"user_avatar" %}
                                <img src="{% get_user_avatar request.user %}" width="50vw" height="50vw" class="" alt="User Image" style="object-fit: cover; border-radius: 50%; object-position: top; margin-right: 5px; margin-left: 5px;"><!--class="img-circle elevation-2"-->
                            {% else %}
                                <i class="fas fa-inverse user-profile fa-user-circle"></i>
                            {% endif %}
                        </div>
                        <div class="info" style="margin-left: 5px; margin-top: 10px;"><!--edit-->
                            {% if perms|can_view_self %}
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column {{ jazzmin_ui.sidebar_list_classes }}" data-widget="treeview" role="menu" data-collapsible="false">
                            ...
                            <li class="nav-item">
                                <a href="{% url 'scraping' %}" class="nav-link">
